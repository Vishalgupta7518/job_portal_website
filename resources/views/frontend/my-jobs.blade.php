                                                ...
                                                <td>
                                                    <div class="action-dots float-end">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            {{-- <li>
                                                                <form action="" id="deleteJob" method="post">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <input type="hidden" name="jobId" value="{{ $job->id }}">
                                                                    <a class="dropdown-item" href="#" onclick="deleteJob()"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a>
