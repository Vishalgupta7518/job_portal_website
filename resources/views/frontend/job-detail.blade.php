    ...
    <div class="container job_details_area">
        <div class="row pb-5">
            <div class="col-md-8">
                    ...
                    <div class="job_details_header">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            ...
                            <div class="jobs_right">
                                <div class="apply_now">
                                    @if (Auth::check())
                                        <a class="heart_mark {{ $saveJobCount==1 ? 'saved-job' : '' }}" href="javascript:void(0);" onclick="saveJob({{ $job->id }})"> <i class="fa fa-heart-o" aria-hidden="true"></i></a>
                                    @else
                ...
                @auth
                    @if (Auth::user()->id == $job->user_id || Auth::user()->role == 'admin')
                        <div class="card shadow border-0 mt-4">
                            ...
                            <div class="descript_wrap white-bg">
                                <table class="table table-striped">
                                    ...
                                    @else
                                            <tr>
                                                <td class="text-center text-danger" colspan="5">Applicants Not Found.</td>
                                            </tr>
                                    @endif                           
                                </table>
                            </div>   
