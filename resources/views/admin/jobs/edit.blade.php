                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    <div class="form-check">
                                        <input {{ ($Job->isFeatured == 1 ) ? 'checked' : '' }} class="form-check-input" name="isFeatured" type="checkbox" value="1" id="isFeatured">
                                ...
                                <div class="mb-4 col-md-6">
                                    <div class="form-check-inline">
                                        <input {{ ($Job->status == 1)  ? 'checked' : '' }} class="form-check-input" name="status" type="radio" value="1" id="status-active">
                                        <label class="form-check-label" for="status-active">
                                            Active
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <input {{ ($Job->status == 0)  ? 'checked' : '' }} class="form-check-input" name="status" type="radio" value="0" id="status-block">
